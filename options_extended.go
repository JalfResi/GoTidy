...
func (this *Tidy) AnchorAsName(val bool) (bool, error) {
	// C.TidyAnchorAsName = 87 it doesn't exists in ptidy
...
func (this *Tidy) MergeSpans(val int) (bool, error) {
	// C.TidyMergeSpans = 86 it doesn't exists in ptidy
...
func (this *Tidy) PreserveEntities(val bool) (bool, error) {
	// C.TidyPreserveEntities = 85 it doesn't exists in ptidy
...
func (this *Tidy) SortAttributes(val int) (bool, error) {
	switch val {
	case None, Alpha:
		// C.TidySortAttributes = 84 it doesn't exists in ptidy
